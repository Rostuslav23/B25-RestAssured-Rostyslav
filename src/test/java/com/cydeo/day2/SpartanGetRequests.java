...
public class SpartanGetRequests {
    ...
    String url = "http://54.210.224.83:8000";


    /**Given Accept type is application/jason
     When user send GET req to api/spartans end point
     Then status code must be 200
     And response content type must be application/json
     */
    @DisplayName("Get all of the spartans")
    @Test
    public void test1(){
...
//content type
     ...
     * And json should contain 'Fidole'
     */
    ...
    public void test2(){
        ...
        //verigy content type is application/json
    ...
    public void test3(){
        ...
        // to get header value we use header() method wich accepts header name as parameter and return value as string
